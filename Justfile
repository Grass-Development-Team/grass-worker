...
build target="all":
    {{ if target == "api" { "cd " + console + " && vp build && rm -rf " + root / "crates" / "assets" / "public" + " && mkdir -p " + root / "crates" / "assets" / "public" + " && cp -r " + console / "dist" / "* " + root / "crates" / "assets" / "public" / " && cargo build -p grass-control-api" } else if target == "node" { "cargo build -p grass-node" } else if target == "console" { "cd " + console + " && vp build" } else if target == "rust" { "cd " + console + " && vp build && rm -rf " + root / "crates" / "assets" / "public" + " && mkdir -p " + root / "crates" / "assets" / "public" + " && cp -r " + console / "dist" / "* " + root / "crates" / "assets" / "public" / " && cargo build --workspace" } else if target == "all" { "cd " + console + " && vp build && rm -rf " + root / "crates" / "assets" / "public" + " && mkdir -p " + root / "crates" / "assets" / "public" + " && cp -r " + console / "dist" / "* " + root / "crates" / "assets" / "public" / " && cargo build --workspace" } else { error("unknown build target: " + target) } }}
