...
pub(crate) async fn record_lifecycle_audit(
...
pub(crate) async fn record_lifecycle_event<C: crate::infra::audit::AuditConnection>(
    db: &C,
    actor: Uuid,
    action: &str,
...
pub(crate) fn runtime_dimension(runtime: &ProjectRuntime) -> QuotaDimension {
    match runtime {
...
#[cfg(test)]
mod tests {
    use crate::infra::{database::entity::TeamMemberRole, http::extractors::Session};
    ...
    async fn team_delete_retry_releases_quota_without_repeating_lifecycle_event() {
        ...
        crate::features::api::v1::projects::by_project_id::delete::delete(
