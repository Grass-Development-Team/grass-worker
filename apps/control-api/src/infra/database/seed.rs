...
const DEFAULT_QUOTA_LIMITS: &[QuotaLimitSeed] = &[
    ...
    QuotaLimitSeed {
        dimension: "build_timeout_seconds",
        period: QuotaPeriod::None,
        free: 600,
        student: 900,
        plus: 1_800,
